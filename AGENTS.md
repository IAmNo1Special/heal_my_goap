...
1. **Pytest & Coverage**: `uv run --dev pytest -v -s --cov=heal_my_goap --cov-report=term-missing --cov-fail-under=100 -W error` (Must yield 100% pass, 100% coverage, 0 warnings).
